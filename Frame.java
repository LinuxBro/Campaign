...
public class Frame extends main{
	...
	private void initialize() {
		...
		lblName.setFont(new Font("Constantia", Font.PLAIN, 30));
		lblName.setBounds(283, 30, 131, 50);
		...
		textArea.setText("p1 | Name:  Fund:  Popularity:  Credibility:  \r\np2 | Name:  Fund:  Popularity:  Credibility:  ");
		textArea.setRows(4);
		...
		textArea_1.setBounds(392, 88, 329, 670);
